...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		monthNames: ["Janeiro","Fevereiro","Março","Abril","Maio","Junnho",
		...
		dayNamesMin: ["Do","Se","Te","Qua","Qui","Sex","Sa"], // Column headings for days starting at Sunday
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		controls = (!inst.inline ? "<button type='button' class='btn btn-primary btn-small done' data-handler='hide' data-event='click'>" +
			this._get(inst, "closeText") + "</button>" : "");

		buttonPanel = (showButtonPanel) ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (isRTL ? controls : "") +
			(this._isInRange(inst, gotoDate) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' style='display: none' data-handler='today' data-event='click'" +
